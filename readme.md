...
The Mini Task Tracker is a lightweight, fully functional task management application built with HTML, CSS, and vanilla JavaScript. It allows users to quickly add, delete, and mark tasks as complete, with data persistence through localStorage.
